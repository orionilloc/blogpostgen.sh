#!/usr/bin/bash
# This a script meant to generate a blog post in Jekyll so that you no longer have to manually input and/or copy information for a couple of minutes. Includes most of the official Chirpy "Text and Typography" page- shortened to the elements I use most often.
...
read challenge_name
echo "Please enter one or more tags in lowercase to associate with your post:"
read post_header_tags
